...
def box2state(box):
    ...
    w = box[2] - box[0]
    h = box[3] - box[1]
    return np.array([[center_x, center_y, w, h, 0, 0]]).T  # defined as [center x,center y, width w, height h, dx, dy]
...
def box2meas(box):
    ...
    w = box[2] - box[0]
    h = box[3] - box[1]
    return np.array([[center_x, center_y, w, h]]).T  # defined as [center x, center y, width w, height h]
