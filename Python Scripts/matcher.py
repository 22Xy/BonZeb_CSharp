...
class Matcher:
    ...
    @classmethod
    def match(cls, state_list, measure_list):  # [c_x, c_y, w, h].T
        """
        Maximum Weighted Matching
        :param state_list: prior state list
        :param measure_list: mesurement list
        :return: dict matching result， eg:{'state_1': 'mea_1', 'state_0': 'mea_0'}
        """
        graph = nx.Graph()
    ...
    def cal_iou(cls, state, measure):
        """
        calculation IOU between state and measurement (Intersection over union)
        ...
        # calculation coordinates of intersection part
